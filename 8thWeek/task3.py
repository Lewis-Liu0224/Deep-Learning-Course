...
(train_x1, train_y), (test_x1, test_y) = boston_housing.load_data()

train_x = train_x1[:, [4, 5, 12]]

test_x = test_x1[:, [4, 5, 12]]
...
for i in range(0, iter + 1):
    ...
    if i % display_step == 0:
        print("i: %i, Tain Loss: %f, Test Loss: %f " % (i, Loss_train, Loss_test))
